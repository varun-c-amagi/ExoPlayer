...
public class SampleChooserActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.play_dash).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                EditText text = findViewById(R.id.url);
                startActivity(new UriSample("url", false, null, text.getText().toString(), "mpd", null).buildIntent(getApplicationContext()));
                Log.d(TAG, "onClick: clicked");
            }
        });
        findViewById(R.id.play_hls).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                EditText text = findViewById(R.id.url);
                startActivity(new UriSample("url", false, null, text.getText().toString(), "hls", null).buildIntent(getApplicationContext()));
            }
        });
